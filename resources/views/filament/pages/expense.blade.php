...
<x-filament-panels::page>
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        @foreach ($this->getShowrooms() as $showroom)
            <a
                href="{{ route('filament.admin.resources.expenses.showroom', ['showroom' => $showroom->id]) }}"
                class="flex flex-col items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 b-yellow-200 transition rounded-xl p-6 shadow-md"
            >
